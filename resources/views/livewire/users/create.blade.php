        ...
        <div class="mx-full sm:px-6 lg:px-8 w-full">
            <div class="bg-[#F5F7FE] overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="text-[#303845] text-bold text-3xl mb-5">AGREGAR USUARIO</div>
                        <form>
                                ...
                                <div class="flex flex-col gap-5 w-1/2">
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <div class="flex">
                                            ...
                                            <button wire:click.prevent="getUsuario()" class="ml-8 bg-gray-600 rounded-full p-3 text-white hover:bg-gray-800">
