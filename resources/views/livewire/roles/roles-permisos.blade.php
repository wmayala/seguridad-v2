        ...
        <div class="grid grid-cols-12 rounded-md shadow-md  shadow-gray-300  p-4">
            ...
            <div class="col-span-full sm:col-span-9">
                <div>
                    ...
                    @if (!$nuevoRol)
                        <button wire:click="formNuevoRol(true)" class="p-2 ml-5 transition duration-300 ease-in-out hover:bg-green-200 rounded-md hover:cursor-pointer shadow-xl bg-green-100 shadow-green-500/50 inline-flex hover:shadow-none items-center dark:text-green-700">
                    ...
                    @else
                        <button wire:click="formNuevoRol(false)" class="p-2 ml-5 transition duration-300 ease-in-out hover:bg-gray-200 rounded-md hover:cursor-pointer shadow-xl bg-gray-100 shadow-gray-500/50 inline-flex hover:shadow-none items-center dark:text-gray-700">
