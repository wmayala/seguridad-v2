            ...
            <div class="bg-[#F5F7FE] overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="flex justify-between">
                        ...
                        <div class="text-[#303845] text-bold text-3xl mb-5">PERSONAL POR ACTIVIDAD</div>
                        @if(Auth::user()->can('crear-personal-actividad'))
                            <div>
                                <a href="{{ route('staff.create') }}"
                                    class="inline-flex items-center px-4 py-2 bg-[#303845] border border-transparent rounded-full font-semibold text-md text-white uppercase tracking-widest hover:bg-[#303845] focus:bg-[#303845]-700 active:bg-[#303845]-900 focus:outline-none focus:ring-2 focus:ring-[#303845] focus:ring-offset-2 transition ease-in-out duration-150">Agregar personal</a>
                            </div>
                        @endif
                    </div>
                    ...
                    <table class="w-full text-lg text-left rtl:text-right text-gray-500">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-[#F5F7FE] border-b hover:bg-gray-200 hover:text-[#303845]">
                                <td class="text-lg p-3"><img class="rounded" src="{{ asset('storage/'.$st->photo) }}" alt="" width="50"></td>
                                ...
                                <td class="text-center">
                                    @if(Auth::user()->can('modificar-personal-actividad'))
                                        <button wire:click="redirectTo('staff.edit',{{ $st->id }})"
