        ...
        <div class="mx-full sm:px-6 lg:px-8 w-full">
            <div class="bg-[#F5F7FE] overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="text-[#303845] text-bold text-3xl mb-5">AGREGAR PERSONAL</div>
                            ...
                            <div class="flex justify-center">
                                <div class="flex flex-col gap-5 w-1/2">
                                    ...
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <select class="border-gray-300 focus:border-[#303845] focus:ring-[#303845] rounded-md shadow-sm" wire:model="activity_id" id="activity_id">
                                    ...
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <input class="border-gray-300 focus:border-[#303845] focus:ring-[#303845] rounded-md shadow-sm" type="date" wire:model="registerDate" id="registerDate">
                                    ...
                                    <div class="flex justify-center gap-3 mt-5">
                                        ...
                                        <a href="{{ route('staff.index') }}"
                                            class="inline-flex items-center px-4 py-2 bg-gray-600 border rounded-full font-semibold text-sm text-white uppercase tracking-widest hover:bg-gray-800 focus:bg-[#303845]-700 active:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-[#303845] focus:ring-offset-2 transition ease-in-out duration-150">
                                            Cancelar
                                        </a>
                                    </div>
                                </div>
