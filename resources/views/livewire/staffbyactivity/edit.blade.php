        ...
        <div class="mx-full sm:px-6 lg:px-8 w-full">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="text-[#111e60] text-bold text-3xl mb-5">ACTUALIZAR PERSONAL</div>
                            ...
                            <div class="flex justify-center">
                                <div class="flex flex-col gap-5 w-1/2">
                                    ...
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <select class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" wire:model.lazy="activity_id" id="activity_id">
                                                ...
                                                <div class="grid grid-cols-[auto_1fr]">
                                                    ...
                                                    <div class="mx-2">
                                                        ...
                                                        <div class="flex flex-row items-center py-1 border-b border-black">
                                                            <div>Cargo: </div>
                                                            <div class="pl-2 w-[300px] h-[40px] truncate text-ellipsis text-lg font-semibold uppercase flex items-center ">{{ $activity_name }}</div>
                                                        </div>
