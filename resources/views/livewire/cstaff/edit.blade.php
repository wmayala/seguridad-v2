                            ...
                            <div class="flex justify-center">
                                <div class="flex flex-col gap-5 w-1/2">
                                    ...
                                    <div class="flex flex-col justify-center">
                                        ...
                                        <select class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" wire:model.lazy="company_id" id="company_id">
                                                ...
                                                <div class="grid grid-cols-[auto_1fr]">
                                                    ...
                                                    <div class="mx-2">
                                                        ...
                                                        <div class="flex flex-row items-center py-1 border-b border-black">
                                                            <div>Empresa: </div>
                                                            <div class="pl-2 w-[300px] h-[40px] truncate text-ellipsis text-lg font-semibold uppercase flex items-center ">{{ $company_name }}</div>
                                                        </div>
