        ...
        <div class="mx-full sm:px-6 lg:px-8 w-full">
            <div class="bg-[#F5F7FE] overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="text-[#303845] text-bold text-3xl mb-5">ACTUALIZAR PERSONAL DE EMPRESA</div>
                            ...
                            <div class="flex flex-col gap-5 w-1/2">
                                ...
                                <div class="flex flex-col justify-center">
                                    ...
                                    <div class="flex justify-center gap-5">
                                        <div class="flex gap-3">
                                            <input
                                                class="text-[#303845] bg-gray-50 border border-[#111e60] rounded-lg focus:ring-[#111e60] focus:border-[#111e60] p-2.5"
                                            ...
                                            <div class="grid grid-cols-[130px_361px]">
                                                ...
                                                <div class="ml-2">
                                                    ...
                                                    <div class="flex gap-2 py-1 border-b border-black">
                                                        <div>Empresa: </div>
                                                        <div class="{{ strlen($company_name) <=25 ? 'text-lg' : 'text-base' }} h-[45px] font-semibold uppercase">
                                                            {{ $company_name }}
                                                        </div>
                                                    </div>
